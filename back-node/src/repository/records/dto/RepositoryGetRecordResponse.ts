...
export class RepositoryGetRecordResponse {
  ...
  private constructor(records: RecordDto[], totalPage: number) {
    this._records = records;
    this._totalPage = totalPage;
  }

  static create(records: RecordDto[], totalPage: number) {
    return new RepositoryGetRecordResponse(records, totalPage);
  }
