...
public class MakeSpringQuiz {
	...
	@Qualifier("apiSpringRequestStep")
	private final Step apiSpringRequestStep;
	...
	public Job makeSpringQuizJob() {
		return makeQuizJobFlow.makeQuizFlow(apiSpringRequestStep,
			makeQuizJobUtils.getConverterFromResponseStep(),
			makeQuizJobUtils.getCategoryMapperStep(), CategoryTitle.SPRING);
	}
}
